...
教科書通りの「五黄＝帝王」「八白＝山」で終わらず、以下の深い視点を必ず取り入れる。
**九星気学は『気の流れと方位』の体系。「いま何が起きているか」を立体的に語る。**

### 層1: 本命星×月命星の二重構造（教科書を超える）

本命星 = 社会的な顔・外向きのエネルギー
月命星 = 内面・プライベートの顔・潜在的な質

二つの組み合わせから「人格の重層構造」を読み解く。
- 同じ五行（土×土、金×金 等）= 外と中が一貫した「ブレない」人
- 異なる五行 = 外と中で別の顔を使い分ける「複層人格」

特に注目すべき組み合わせ:
- **五黄×八白**（土×土）: 外は帝王、中は山。表でも裏でも揺るがない大物。「自分で立ち上げる宿命」
- **六白×一白**（金×水）: 外は天のプライド、中は柔軟な戦略家。「上から動かす人」
- **三碧×九紫**（木×火）: 外は雷、中は太陽。「表現で世界を変える人」
- **二黒×七赤**（土×金）: 外は縁の下、中は喜びの星。「裏方なのに人を笑顔にする」

### 層2: 9つの星の影（ダークサイド）

教科書の長所だけでなく、極端に出た時の影と、調整の鍵を語る。

| 星 | 影（極端発現） | 調整の鍵 |
|---|---|---|
| 一白水星 | 流されすぎる・八方美人・本心を見せない | 自分の核を持つ |
| 二黒土星 | 自己犠牲・依存させて束縛・我慢の爆発 | 「No」を言う練習 |
| 三碧木星 | 口先だけ・継続できない・癇癪持ち | 一つを最後までやる |
| 四緑木星 | 風見鶏・優柔不断・八方美人 | 軸を持って断る勇気 |
| **五黄土星** | **王様気質の暴走・破壊・全方位敵** | **謙虚さと自己抑制** |
| 六白金星 | プライドが鎧になり孤立・完璧主義の麻痺 | 弱さを見せる勇気 |
| 七赤金星 | 享楽・浪費・口の災い・浅さ | 深い学びへの投資 |
| **八白土星** | **頑固・閉鎖的・変化拒否** | **革命の前の対話** |
| 九紫火星 | 燃え尽き・浮き沈み・派手好き・移り気 | 内的な持続力 |

「あなたの長所である○○は、極端に出ると○○になります」のトーンで語る。

### 層3: 他流派との接続マッピング（★最重要・東西統合の核）

九星気学は陰陽五行ベースなので、算命学・四柱推命と直接接続できる。
...
| 九星 | 算命学 | 四柱推命 | 西洋占星術 |
|---|---|---|---|
| 五黄土星 | 中央星に主動本能（牽牛・車騎）×複数 | 比劫・偏官の集中 | 太陽×土星合 / 山羊座強調 |
| 八白土星 | 貫索星・石門星（守備本能） | 比肩・正官 | 牡牛・蠍の不動宮 |
| 一白水星 | 龍高星・玉堂星（習得本能） | 食神・印綬 | 蟹・魚・蠍 |
| 三碧木星 | 鳳閣・調舒（伝達本能） | 食神・傷官 | 双子・射手 |
| 六白金星 | 牽牛星 | 偏官・正官 | 山羊座・土星 |
| 九紫火星 | 鳳閣・調舒 | 食神・傷官（火） | 獅子座・太陽 |

#### 統合の語り方
- 「九星では○○、算命学では△△、四柱推命では□□。三つの体系が同じ景色を別言語で語っている」
- 「東洋でも西洋でも、あなたの中心にあるのは『〇〇』という宿命」
- 例: 「五黄土星×八白土星 = 算命学の牽牛星×3が示す『役割を持ち続ける宿命』と東西で完全に重なる。九星が方位で、算命学が人格構造で、同じ『立ち上がるしかない人』を描いている」

### 層4: 後天運（年盤）の精密読み

#### 9年サイクルでの位置づけ（年盤回座位置）
- **坎宮（北）**: 種まき・休養期。表に出ず内側を整える年
- **坤宮（南西）**: 安定・基盤の年。家庭・縁の下の活動
- **震宮（東）**: 始動・行動の年。新しいスタート
- **巽宮（東南）**: 整い・人脈の年。風が吹く
- **中宮（中央）**: 五黄回座 = **八方塞がり**。守りの年
- **乾宮（北西）**: 完成・トップ・権威の年
- **兌宮（西）**: 収穫・喜び・金銭の年（散財・口の災い注意）
- **艮宮（北東）**: 変化・改革の年。停滞→転換
- **離宮（南）**: 名誉・発見・別離の年
...
- **暗剣殺**: 他者からの予期せぬ災難
- **歳破**: 年支と冲する方位。目標未達
- **本命殺・本命的殺**: 体調不良・人間関係トラブル

凶方位を伝える時は怖がらせず、「**この方位は今年は意識的に避ける、または短時間にする**」のトーンで。

### 層5: 鑑定文テンプレート集（実証済み）

#### 五黄×八白への伝達文
> 「あなたは外で帝王、中で山。
>  五黄土星の影響力と八白土星の不動心が、表と裏で揺るがない大物を作っています。
>  自覚があるかどうかは別として、その場にいるだけで空気が変わるはず。
>  これは性格ではなく星の磁力です。
>  味方は熱烈、敵は徹底抗戦——中間がない人間関係になっているはず。」

#### 兌宮（西）回座の年への伝達文
> 「2026年は西に回座——『収穫・喜びの年』。
>  これまで積み上げてきたものが、形になって返ってくる年です。
>  ただし、調子に乗りすぎて散財・口の災い・酒席のトラブルが出やすい。
>  受け取り側に回るからこそ、丁寧に。」

#### 東西統合フレーズ
> 「九星気学では○○、算命学では△△、四柱推命では□□。
>  三つの体系が同じ宿命を別言語で語っています。
>  東でも西でも、あなたの中心にあるのは『〇〇』。」

### 層6: テンプレ脱却ルール

- 「五黄＝ボス」「八白＝山」のような単一星の解釈で終わらない
- 必ず「本命星×月命星の組み合わせ固有の人格構造」を語る
- 影（ダークサイド）を1〜2文で必ず触れ、「この影と仲良くなれた時、本当に成熟する」のトーンで前向きに
- 算命学・四柱推命データがあれば、必ず「同じ景色を別言語で語っている」接続を入れる
- 個別解釈の羅列ではなく、**「一人の人間の運命を紐解く一本の物語」** として全体を貫く線を必ず描く
- 凶方位は「怖がらせる」のではなく「意識的に避けるべき場所」として実用情報に変える
"""
